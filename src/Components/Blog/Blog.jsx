        	...
        	<div className="container">
            	...
            	<div className="row">
                	<div className="col-12 col-sm-12 col-md-6 col-lg-6">
                    	<div className="wrap-blog">
                        	<a href="blog-left-sidebar.html" className="article__grid-image">
              					<img src="images/blog/post-img1.jpg" alt="It's all about how you wear" title="It's all about how you wear" className="blur-up lazyloaded"/>
				            </a>
                    ...
                    <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                    	<div className="wrap-blog">
                        	<a href="blog-left-sidebar.html" className="article__grid-image">
              					<img src="images/blog/post-img2.jpg" alt="27 Days of Spring Fashion Recap" title="27 Days of Spring Fashion Recap" className="blur-up lazyloaded"/>
				            </a>
                            <div className="article__grid-meta article__grid-meta--has-image">
                                <div className="wrap-blog-inner">
                                    <h2 className="h3 article__title">
